...
g_reg<- g_reg[, c("produce","year","month")]
setnames(g_reg, "produce", "g_pro")
...
# change into seasons
reg<- reg[ ,month := ifelse( month%%12 %in% c(1,2,3), 1, month )]
reg<- reg[ ,month := ifelse( month%%12 %in% c(4,5,6), 2, month )]
reg<- reg[ ,month := ifelse( month%%12 %in% c(7,8,9), 3, month )]
reg<- reg[ ,month := ifelse( month%%12 %in% c(10,11,0), 4, month )]
...
f<- lm(produce ~g_pro+ company + cc + year.x+ month, data = reg , na.rm= TRUE)
f1<- lm(produce ~g_pro*cc+ company + cc + year.x+ month, data = reg , na.rm= TRUE)
f2<- lm(produce ~g_pro*company+ company + cc + year.x+ month, data = reg , na.rm= TRUE)
...
lf<- lm(produce ~g_pro+ company + cc + year.x+ month, data = lreg , na.rm= TRUE)
lf1<- lm(produce ~g_pro+ g_pro*cc+ company + cc + year.x+ month, data = lreg , na.rm= TRUE)
lf2<- lm(produce ~g_pro + g_pro*company+ g_pro*cc + company + cc + year.x+ month, data = lreg , na.rm= TRUE)
