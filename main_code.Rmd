...
lapply(list( d2007, d1907, d1807),function(x){ return(x[,"month":=7])})
lapply(list( d2008, d1908, d1808),function(x){ return(x[,"month":=8])})
lapply(list( d2009, d1909, d1809),function(x){ return(x[,"month":=9])})
lapply(list( d2010, d1910, d1810),function(x){ return(x[,"month":=10])})
lapply(list( d2011, d1911, d1811),function(x){ return(x[,"month":=11])})
lapply(list( d2012, d1912, d1812),function(x){ return(x[,"month":=12])})
```
